    ...
    <section className={heroWrapper} id="hero">
      <div>
        ...
        <div className={heroContent}>
          <h3>PASIÓN PROPIA</h3>
          <p className={description}>NeoFuTbol es la evolución de los albumes.</p>
          <p className={description}>Un proyecto Web3 con el que podrás tener un álbum del mundial con NFTs.</p>
          <ButtonConnect />
        </div>
